...
// Image assets — inline SVG data URIs for reliable rendering (no external deps)
const imgGlobalAeroFleet = "/partners/globalaero.svg";
const imgAviationParts = "/partners/aerotech.svg";

const imgAIPredictive = `data:image/svg+xml;utf8,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
    <defs>
        <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stop-color="#155dfc"/>
            <stop offset="100%" stop-color="#0e3fc0"/>
        </linearGradient>
    </defs>
    <rect width="800" height="600" fill="url(#bg)"/>
    <g opacity="0.12" fill="#fff">
        <circle cx="650" cy="120" r="180"/>
        <circle cx="150" cy="480" r="140"/>
    </g>
    <!-- chart bars -->
    <rect x="120" y="340" width="60" height="160" rx="8" fill="#fff" opacity="0.25"/>
    <rect x="220" y="280" width="60" height="220" rx="8" fill="#fff" opacity="0.35"/>
    <rect x="320" y="220" width="60" height="280" rx="8" fill="#fff" opacity="0.45"/>
    <rect x="420" y="160" width="60" height="340" rx="8" fill="#fff" opacity="0.55"/>
    <rect x="520" y="120" width="60" height="380" rx="8" fill="#fff" opacity="0.7"/>
    <!-- trend line -->
    <polyline points="150,320 250,260 350,200 450,140 550,100" fill="none" stroke="#93c5fd" stroke-width="4" stroke-linecap="round"/>
    <!-- icon -->
    <circle cx="550" cy="100" r="14" fill="#93c5fd"/>
    <g fill="#fff" font-family="Arial,sans-serif">
        <text x="120" y="80" font-size="32" font-weight="700">AI-Powered</text>
        <text x="120" y="120" font-size="24" opacity="0.8">Predictive Analytics</text>
    </g>
</svg>`
)}`;

const imgCompliance = `data:image/svg+xml;utf8,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
    <defs>
        <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
    ...
    <g opacity="0.1" fill="#fff">
        <circle cx="680" cy="150" r="200"/>
        <circle cx="120" cy="500" r="160"/>
    </g>
    <!-- clipboard -->
    <rect x="280" y="140" width="240" height="340" rx="16" fill="#fff" opacity="0.2"/>
    <rect x="360" y="120" width="80" height="40" rx="8" fill="#fff" opacity="0.3"/>
    <!-- check rows -->
    <circle cx="330" cy="230" r="14" fill="#6ee7b7"/>
    <rect cx="330" cy="230" x="360" y="220" width="120" height="16" rx="4" fill="#fff" opacity="0.4"/>
    <circle cx="330" cy="280" r="14" fill="#6ee7b7"/>
    <rect x="360" y="270" width="140" height="16" rx="4" fill="#fff" opacity="0.4"/>
    <circle cx="330" cy="330" r="14" fill="#6ee7b7"/>
    <rect x="360" y="320" width="100" height="16" rx="4" fill="#fff" opacity="0.4"/>
    <circle cx="330" cy="380" r="14" fill="#fff" opacity="0.2"/>
    <rect x="360" y="370" width="130" height="16" rx="4" fill="#fff" opacity="0.2"/>
    <!-- shield -->
    <path d="M400 440 L440 460 L440 500 C440 520 420 535 400 545 C380 535 360 520 360 500 L360 460 Z" fill="#6ee7b7" opacity="0.6"/>
    <g fill="#fff" font-family="Arial,sans-serif">
        <text x="100" y="80" font-size="32" font-weight="700">Regulatory</text>
        <text x="100" y="120" font-size="24" opacity="0.8">Compliance Automation</text>
    </g>
</svg>`
)}`;

const imgIoTMonitoring = `data:image/svg+xml;utf8,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
    <defs>
        <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
    ...
    <!-- aircraft silhouette -->
    <ellipse cx="400" cy="280" rx="200" ry="30" fill="#fff" opacity="0.15"/>
    <path d="M250 280 L400 240 L550 280 L400 260 Z" fill="#fff" opacity="0.2"/>
    <!-- pulse rings -->
    <circle cx="400" cy="280" r="60" fill="none" stroke="#c4b5fd" stroke-width="2" opacity="0.4"/>
    <circle cx="400" cy="280" r="100" fill="none" stroke="#c4b5fd" stroke-width="2" opacity="0.25"/>
    <circle cx="400" cy="280" r="140" fill="none" stroke="#c4b5fd" stroke-width="2" opacity="0.15"/>
    <!-- data nodes -->
    <circle cx="320" cy="380" r="10" fill="#c4b5fd"/>
    <circle cx="480" cy="380" r="10" fill="#c4b5fd"/>
    <circle cx="400" cy="420" r="10" fill="#c4b5fd"/>
    <line x1="320" y1="380" x2="400" y2="280" stroke="#c4b5fd" stroke-width="1.5" opacity="0.4"/>
    <line x1="480" y1="380" x2="400" y2="280" stroke="#c4b5fd" stroke-width="1.5" opacity="0.4"/>
    <line x1="400" y1="420" x2="400" y2="280" stroke="#c4b5fd" stroke-width="1.5" opacity="0.4"/>
    <!-- live indicator -->
    <circle cx="660" cy="60" r="8" fill="#a78bfa"/>
    <circle cx="660" cy="60" r="14" fill="none" stroke="#a78bfa" stroke-width="2" opacity="0.5"/>
    <g fill="#fff" font-family="Arial,sans-serif">
        <text x="100" y="80" font-size="32" font-weight="700">Real-Time IoT</text>
        <text x="100" y="120" font-size="24" opacity="0.8">Monitoring Dashboard</text>
    </g>
</svg>`
)}`;

const imgSmartWorkflows = `data:image/svg+xml;utf8,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
    <defs>
        <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
    ...
    <rect width="800" height="600" fill="url(#bg)"/>
    <g opacity="0.1" fill="#fff">
        <circle cx="680" cy="130" r="190"/>
        <circle cx="130" cy="490" r="150"/>
    </g>
    <!-- workflow cards -->
    <rect x="160" y="180" width="200" height="100" rx="12" fill="#fff" opacity="0.2"/>
    <rect x="180" y="200" width="120" height="12" rx="4" fill="#fff" opacity="0.5"/>
    <rect x="180" y="224" width="80" height="12" rx="4" fill="#fff" opacity="0.3"/>
    <rect x="180" y="248" width="140" height="12" rx="4" fill="#fed7aa" opacity="0.6"/>
    <rect x="440" y="180" width="200" height="100" rx="12" fill="#fff" opacity="0.2"/>
    <rect x="460" y="200" width="100" height="12" rx="4" fill="#fff" opacity="0.5"/>
    <rect x="460" y="224" width="140" height="12" rx="4" fill="#fff" opacity="0.3"/>
    <rect x="460" y="248" width="60" height="12" rx="4" fill="#fed7aa" opacity="0.6"/>
    <!-- connector arrow -->
    <line x1="370" y1="230" x2="430" y2="230" stroke="#fff" stroke-width="3" opacity="0.5"/>
    <polygon points="430,222 445,230 430,238" fill="#fff" opacity="0.5"/>
    <!-- bottom card -->
    <rect x="300" y="340" width="200" height="100" rx="12" fill="#fff" opacity="0.25"/>
    <rect x="320" y="360" width="110" height="12" rx="4" fill="#fff" opacity="0.5"/>
    <rect x="320" y="384" width="90" height="12" rx="4" fill="#fff" opacity="0.3"/>
    <rect x="320" y="408" width="130" height="12" rx="4" fill="#6ee7b7" opacity="0.6"/>
    <!-- connector down -->
    <line x1="540" y1="286" x2="400" y2="332" stroke="#fff" stroke-width="2" opacity="0.3"/>
    <g fill="#fff" font-family="Arial,sans-serif">
        <text x="120" y="80" font-size="32" font-weight="700">Smart Maintenance</text>
        <text x="120" y="120" font-size="24" opacity="0.8">Workflows</text>
    </g>
</svg>`
)}`;
